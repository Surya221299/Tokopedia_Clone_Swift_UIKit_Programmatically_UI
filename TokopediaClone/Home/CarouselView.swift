...
//  TokopediaClone
//
//  Created by Bamantara S on 02/04/24.
//
...
private extension CarouselView {
    ...
    func setupCollectionView() {
        ...
        let cellPadding = (frame.width - 414) / 2
        let carouselLayout = UICollectionViewFlowLayout()
        carouselLayout.scrollDirection = .horizontal
        //carouselLayout.itemSize = .init(width: 300, height: 400)
        carouselLayout.itemSize = .init(width: 414, height: 138)
        ...
        carouselCollectionView.heightAnchor.constraint(equalToConstant: 138).isActive = true
    }
    
    func setupPageControl() {
        addSubview(pageControl)
        pageControl.translatesAutoresizingMaskIntoConstraints = false
        pageControl.topAnchor.constraint(equalTo: carouselCollectionView.bottomAnchor, constant: -32).isActive = true
